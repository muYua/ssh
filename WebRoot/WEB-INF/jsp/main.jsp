            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 读者列表
                    </div>
                ...
                <div class="tpl-block">
                    <%-- <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                      	...
                      	<form action="go_query" method="post">
                        <div class="am-u-sm-12 am-u-md-3">
				            <div class="am-form-group">
				          	<select data-am-selected="{btnSize: 'sm'}" name="queryKey">
				          	 <option value="option1">读者名模糊查询</option>
				             <option value="option2">读者名准确查询</option>
				           </select>
                            </div>
                        </div>
                        <div class="am-u-sm-12 am-u-md-3">
                        ...
                        <div class="am-u-sm-12">
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
									<c:if test="${userList==null?false:true}">
                                    <thead>
                                        <tr>
                                            <th class="table-check"><input type="checkbox" class="tpl-table-fz-check"></th>
                                            <th class="table-id">编号</th>
                                            <th class="table-title">读者ID</th>
                                            <th class="table-type">读者名</th>
                                            <th class="table-author am-hide-sm-only">读者密码</th>
					...
					href="go_toUpdate?id=<s:property value="id"/>&userName=<s:property value="userName" />&password=<s:property value="password" />"><span class="am-icon-pencil-square-o"></span> 编辑</a>
                                                        <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" href="go_delete?id=<s:property value="id" />" ><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
