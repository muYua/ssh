                ...
                <div class="tpl-block">
                    <%-- <div class="am-g">
                        <div class="am-u-sm-12 am-u-md-6">
                      	...
                      	<form action="book/go_query" method="post">
                        <div class="am-u-sm-12 am-u-md-3">
				            <div class="am-form-group">
				          	<select data-am-selected="{btnSize: 'sm'}" name="queryKey">
				          	 <option value="option1">图书名模糊查询</option>
				             <option value="option2">图书名准确查询</option>
				             <option value="option3">图书作者查询</option>
				             <option value="option4">图书ID查询</option>
				           </select>
                            </div>
                        </div>
                        &nbsp;&nbsp;&nbsp;
                        ...
                        <div class="am-u-sm-12">
                            <form class="am-form">
                                <table class="am-table am-table-striped am-table-hover table-main">
									<c:if test="${bookList==null?false:true}">
                                    <thead>
                                        <tr>
                                            <th class="table-check"><input type="checkbox" class="tpl-table-fz-check"></th>
                                            <th class="table-id">编号</th>
                                            <th class="table-title">图书ID</th>
                                            <th class="table-type">图书名</th>
                                            <th class="table-author am-hide-sm-only">图书作者</th>
                                            <th class="table-title">图书价格</th>
                                            <th class="table-title">借阅读者ID</th>
                                            <th class="table-title">借阅读者姓名</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><s:property value="reader.id"/></td>
                                            <td><s:property value="reader.userName"/></td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary"
															href="book/go_toUpdate?
															id=<s:property value="id"/>
															&bookName=<s:property value="bookName" />
															&author=<s:property value="author"/>
															&bookPrice=<s:property value="bookPrice"/>
															&reader.userName=<s:property value="reader.userName"/>
															">
															<span class="am-icon-pencil-square-o"></span> 编辑</a>
                                                        <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" 
                                                        	href="book/go_delete?id=<s:property value="id"/>
                                                        	">
